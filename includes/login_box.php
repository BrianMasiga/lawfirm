...
$(document).ready(function(){
	...
	$('#login').click(function(){ // Create `click` event function for login
		...
		if(username.val() == ''){ // Check the username values is empty or not
			...
			login_result.html('<span class="error">Username required.</span>');
			return false;
		}
		if(password.val() == ''){ // Check the password values is empty or not
			password.focus();
			login_result.html('<span class="error">Password required.</span>');
			return false;
		}
				...
				<div style="margin-top: 15px;">
					...
					<table align="center" style="margin-top: 10px;">
						<tr align="center" style="padding: 10px;">
							<td><input type="submit" name="login" id="login" class="as_button" value="Login &raquo;" /><input type="reset" value="  Clear  "></td>
						</tr>
					</table>
					</form>
				</div>
