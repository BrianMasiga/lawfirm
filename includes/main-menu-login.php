<div id="main-menu">
			...
			<!--Start of user menu / Search-->	
				...
				<div id="user-menu">
						...
						<div class="btn-group">
							<a class="btn btn-primary" style="height: 30px; padding: 4px;" href="#"><i class="glyphicon glyphicon-user"></i> 
								...
								<ul class="dropdown-menu">
									<li><a href="edit.php"><i class="glyphicon glyphicon-pencil"></i> Update Account</a></li>
									<li><a href="#"><i class="glyphicon glyphicon-picture"></i> Update Profile Picture</a></li>
									<li class="divider"></li>
