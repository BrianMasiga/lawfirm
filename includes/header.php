...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<?php
			...
			if($page_name[1] == "index.php") {
		?>
		<?php }else{ ?>
		
	<!-- Notification-->
		<script src="nofication/js/jquery.js"></script>
		<script src="nofication/js/notifIt.js"></script>
		<link href="nofication/css/style.css" type="text/css" rel="stylesheet">
		<link href="nofication/css/notifIt.css" type="text/css" rel="stylesheet">
		...
		$(document).ready(function(){
				...
				$(".all").click(function () {
					if ($(".all_notify").is(":hidden")) {
						...
						$(".all_notify").load("loadData-pagination.php");
				...
				$(".event").click(function () {
					if ($(".event_notify").is(":hidden")) {
						...
						$(".event_notify").load("event_notify.php");
				...
				$(".sched").click(function () {
					if ($(".sched_notify").is(":hidden")) {
						...
						$(".sched_notify").load("sched_notify.php");
				...
				$(".contact").click(function () {
					if ($(".contact_notify").is(":hidden")) {
						...
						$(".contact_notify").load("contact_notify.php");
				...
				$(".task").click(function () {
					if ($(".task_notify").is(":hidden")) {
						...
						$(".task_notify").load("task_notify.php");
				...
				$(".memo").click(function () {
					if ($(".memo_notify").is(":hidden")) {
						...
						$(".memo_notify").load("memo_notify.php");
