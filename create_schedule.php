...
<body>
	<h4 id="upload-doc-header">&nbsp;&nbsp;&nbsp;Create New Schedule</h4>
	...
	<div id="wrapper-upload-files" style="width: 500px;">
		...
		<form  method="post" name="form" action="exec_create_schedule.php?redirect_page=<?=$get_page;?>" id="addSchedForm" >
			<div class="form-group">
				...
				<input type="text" name="title" id="title" class="form-control" placeholder="Schedule Name" required>
			</div>
			<div class="form-group">
					<label for="name">Details</label>
					<textarea name="details" id="details" class="form-control" rows="3" placeholder="Schedule Details" required></textarea>
			</div>
			<div class="form-group">
				<label for="name">Court</label>
				<input type="text" name="court" id="court" class="form-control" placeholder="Schedule Court" required>
			</div>
			<div class="form-group">
				<label for="name">When</label>
					<input type="text" name="date" id="schedule_date" class="form-control" placeholder="Schedule date" style="width: 140px" required>
			...
			<div class="form-actions">
				<input type="submit" name="btnCreateEvent" value="Create Schedule" class="btn btn-primary btn-large" id="btnCreateEvent" onclick="validateEventForm();">
				<!--$.facebox.close()-->
			</div>
		</form>
