			...
			<script type="text/javascript"> 
				$(document).ready(function() {
					jQuery(window).load(function () {
						<?php
							$sql = "Select * From tb_events Where event_id='$get_eventid' ";
							foreach($dbh->query($sql) as $result_views){
								$get_lastDocView = $result_views['views'];
							}
							$count_views = $get_lastDocView+1;
							$sql = "Update tb_events Set views='$count_views' Where event_id='$get_eventid' ";
							$dbh->query($sql);
						?>
					});
				});
						...
						<div id="view-doc-body">
										...
										<div class="btn-group">
											<a class="btn btn-primary" style="height: 30px; padding: 4px;" href="#">Actions</a>
												...
												<ul class="dropdown-menu">
													<li><a href="doc_edit.php?edit_id=<?=$get_eventid;?>"><i class="glyphicon glyphicon-pencil"></i> Update</a></li>
													<li><a href="doc_comment.php?comment_id=<?=$get_eventid;?>" rel="facebox"><i class="glyphicon glyphicon-comment"></i> Comment</a></li>
													<li><a href="doc_download.php?download_id=<?=$get_eventid;?>" rel="facebox"><i class="glyphicon glyphicon-download"></i> Download</a></li>
												</ul>
										</div>
										</div>
							<?php
							...
							<div id="style-activity-doc" style="width: 610px; height: 515px; margin-top: 10px;">
								...
								<div id="style-activity" style="width: 590px; margin-top: 10px;">
										 ...
										 $.post("exec_comment.php", { docid: docid, userid: userid, comment: comment, username: username, firstname: firstname, lastname: lastname, category: category, status: status },
										   function(data) {
												notif({
													...
													$("#comment").val("");
													$("#doc-comments").load("doc_comments.php?docid=<?=$get_eventid;?>&&cat=<?=$get_cat;?>");
									...
									<form>
										<div class="form-group" style="padding: 10px;">
											<input type="hidden" id="docid" name="docid" value="<?=$get_eventid;?>">
								...
								<div id="style-activity" style="width: 590px; height: 304px; margin-top: 10px; padding: 10px;">
									<div id="doc-comments">
										<?php
											$sql = "Select * From tb_doc_comments Where doc_id='$get_eventid' And category='$get_cat' Order By doc_comment_id DESC";
